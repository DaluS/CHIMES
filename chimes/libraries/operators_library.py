...
class Operators:
    ...
    def normalnoise(nx, nr):
        """Generate a normal noise around 0. nx and nr are the number of parrallel simulations and regions."""
        return np.random.normal(loc=0, size=(nx, nr, 1, 1))
