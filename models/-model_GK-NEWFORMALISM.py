...
# ---------------------------
# Description that will be shown when the user load the model
# or browse through models
_DESCRIPTION = """
    DESCRIPTION : This is a Goodwin model based on extensive variables.
    Inflation not integrated to the process
    TYPICAL BEHAVIOR : Convergence toward solow point ( good equilibrium) or
    debt crisis
    LINKTOARTICLE :
    """
