...
_LOGICS = {
    ...
    'ode': {
        ...
        'N': {
            'func': lambda itself=0, beta=0:  itself*beta,
        ...
        'w': {
            'func': lambda itself=0, phillips=0, gammai=0, i=0: (phillips+gammai*i)*itself,
            'com': 'Philips negociation'},

        # Sector properties
        'K': {
            'func': lambda Ir=0, delta=0, itself=0:  Ir - delta*itself,
            'com': 'Productive capital accumulation'},
        'u': {
            'func': lambda itself=0, sigma=0, pi=0, dotV=0, V=1: (1-itself)*sigma*dotV/V,
            'com': 'Rate of utilisation adjustment'},
        'V': {
            'func': lambda dotV=0:  dotV,
            'com': 'inventory logic moved in dotV'},
        'p': {
            'func': lambda itself=0, i=0:  itself*i,
            'com': 'price from inflation'},
        'D': {
            'func': lambda r=0, itself=0, w=0, L=0, C=0, p=0: r*itself + w*L - C*p,
            'com': 'Stock-flow on household, no share/bank profits'},
    },
    ...
    'statevar': {
        ...
        'Y': {
            'func': lambda u=0, K=0, nu=1:  u*K/nu,
            'com': 'Production Leontiev optimised with use'},
        'L': {
            'func': lambda Y=0, a=1:  Y/a,
        ...
        'omega': {
            'func': lambda w=0, L=0, p=1, Y=1: w*L/(p*Y),
            'com': 'wage share'},
        ...
        'pi': {
            'func': lambda c=0, p=1, r=0, d=0:  1 - c/p - r*d,
