...
_LOGICS['ode']['K']['units'] = 'T$_{t0}'
_LOGICS['ode']['w']['units'] = 'T$/Humans/y'
_LOGICS['ode']['D']['units'] = 'T$'
_LOGICS['ode']['p']['units'] = ''
...
_LOGICS['ode']['pbackstop']['units'] = '$_{t0}'
_LOGICS['ode']['pcarbon_pot']['units'] = '$_{t0}'
_LOGICS['ode']['sigmaEm']['units'] = 'GtCO2/T$_{t0}'
_LOGICS['ode']['gsigmaEm']['units'] = 'y^{-1}'
_LOGICS['ode']['Eland']['units'] = 'GtCO2/y'
_LOGICS['statevar']['Y']['units'] = 'T$_ {t0}/y'
_LOGICS['statevar']['L']['units'] = 'Humans'
_LOGICS['statevar']['phillips']['units'] = 'y^{-1}'
_LOGICS['statevar']['I']['units'] = 'T$_{t0}/y'
...
_LOGICS['statevar']['Emission']['units'] = 'GtCO2/y'
...
_LOGICS['statevar']['Eind']['units'] = 'GtCO2/y'
_LOGICS['statevar']['Y0']['units'] = 'T$_{t0}/y'
_LOGICS['statevar']['emissionreductionrate']['units'] = ''
_LOGICS['statevar']['pcarbon']['units'] = '$_{t0}/tCO2'
_LOGICS['statevar']['Abattement']['units'] = ''
_LOGICS['statevar']['carbontax']['units'] = ''
...
_LOGICS['param']['rhoAtmo'] = {'units': 'undefined'}
_LOGICS['param']['gammaAtmo'] = {'units': 'undefined'}
_LOGICS['param']['Capacity'] = {'units': 'undefined'}
_LOGICS['param']['Capacity0'] = {'units': 'undefined'}
_LOGICS['param']['deltapbackstop'] = {'units': ''}
_LOGICS['param']['apc'] = {'units': ''}
_LOGICS['param']['bpc'] = {'units': ''}
...
_LOGICS['param']['F2CO2'] = {'units': 'undefined'}
