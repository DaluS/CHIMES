...
This pattern is consistent with data for the United States. Thus, the model framework enables realistic investigation of trade-offs between economic distribution, size, and resources consumption between sectors as well
as between labor and capital. These trade-offs are core to the debates regarding environmental and socioeconomic sustainability. This model serves as a platform upon which to add features to explore long-term
...
#_LOGICS = mergemodel(_LOGICS, _LOGICS_ADDSTOCKFLOW, verb=False) 
