...
#_LOGICS = mergemodel(_LOGICS, _LOGICS_COSTPUSH     ) 
#_LOGICS = mergemodel(_LOGICS, _LOGICS_CES          ) 
#_LOGICS = mergemodel(_LOGICS, _LOGICS_PHILLIPS     ) 
#_LOGICS = mergemodel(_LOGICS, _LOGICS_PROGRESS     ) 
#_LOGICS = mergemodel(_LOGICS, _LOGICS_INCREASING_RETURN) 
#_LOGICS = mergemodel(_LOGICS, _LOGICS_RECRUITMENT   ) 
#_LOGICS = mergemodel(_LOGICS, _LOGICS_BKBUFF        ) 
_LOGICS = mergemodel(_LOGICS, _LOGICS_DELTAENDO)     
#_LOGICS = mergemodel(_LOGICS, _LOGICS_CHANGEPARAM)     
###############################################################################
